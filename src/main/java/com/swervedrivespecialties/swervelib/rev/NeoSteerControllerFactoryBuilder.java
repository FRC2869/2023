...
public final class NeoSteerControllerFactoryBuilder {
    ...
    public class FactoryImplementation<T> implements SteerControllerFactory<ControllerImplementation, NeoSteerConfiguration<T>> {
        ...
        public ControllerImplementation create(NeoSteerConfiguration<T> steerConfiguration, ModuleConfiguration moduleConfiguration) {
            ...
            PIDController pid = new PIDController(pidProportional, pidIntegral, pidDerivative);
            ...
            return new ControllerImplementation(motor, absoluteEncoder, pid);
        }
    }

    public static class ControllerImplementation implements SteerController {
        private static final int ENCODER_RESET_ITERATIONS = 10;
        ...
        public void setReferenceAngle(double referenceAngleRadians) {
            ...
            if (Math.abs(motorEncoder.getVelocity()) < ENCODER_RESET_MAX_ANGULAR_VELOCITY) {
                if (false && ++resetIteration >= ENCODER_RESET_ITERATIONS && false) {
                    resetIteration = 0;
            ...
            double currentAngleRadiansMod = currentAngleRadians;
            ...
            motor.set(-pid.calculate(currentAngleRadiansMod, adjustedReferenceAngleRadians));
