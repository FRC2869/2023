...
public class DrivetrainSubsystem extends SubsystemBase {
        ...
        public double getDriveEncoder() {
            return (m_frontLeftModule.getDrivePosition()+m_frontRightModule.getDrivePosition()+m_backLeftModule.getDrivePosition()+m_backRightModule.getDrivePosition())/4.0;
        }
