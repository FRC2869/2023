...
public class ArmDoubleSubStationFront extends CommandBase{
	...
	public void execute(){
		...
		wrist.position(WristConstants.doubleSubstationFrontAngle);
	}
	...
	public boolean isFinished(){
		...
		boolean wristDone = Math.abs(wrist.getAngle()-WristConstants.doubleSubstationFrontAngle) < WristConstants.tolerance;
