...
public class AutoScoreCubeHigh extends SequentialCommandGroup {
    public AutoScoreCubeHigh(){
        super(new ArmCubeHighBack(), new ParallelRaceGroup(new OpenGrabber(), new WaitCommand(1)), new ParallelRaceGroup(new OffGrabber(), new WaitCommand(.25)), new ArmBasePos());
    }
}
