...
public class ArmScoreCubeMid extends SequentialCommandGroup {
    public ArmScoreCubeMid(){
        super(new ArmCubeMidBack(), new ParallelRaceGroup(new OpenGrabber(), new WaitCommand(1)), new ParallelRaceGroup(new OffGrabber(), new WaitCommand(.25)), new ArmBasePos(), new AutoForwardsDist(1));
    }
}
